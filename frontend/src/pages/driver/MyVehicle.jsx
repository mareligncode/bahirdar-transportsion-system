      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No vehicle assigned</h3>
            <p className="mt-1 text-sm text-gray-500">
              You don't have any vehicle assigned to you yet.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="p-4 border-t border-gray-200">
                <h3 className="font-medium text-gray-900 mb-2">Vehicle Gallery</h3>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-900 capitalize">{vehicle.color}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Type</p>
                  <p className="text-base text-gray-900 capitalize">{vehicle.carType}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Capacity</p>
                  <p className="text-base text-gray-900">{vehicle.totalCapacity} seats</p>
                </div>
              </div>
            </div>
            ...
            {/* Status & Documents */}
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Status & Documents</h2>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="flex items-center space-x-3 mb-4">
                    <div className={`p-2 rounded-full ${
                      vehicle.currentStatus === 'active' ? 'bg-green-100' :
                      vehicle.currentStatus === 'maintenance' ? 'bg-red-100' :
                      vehicle.currentStatus === 'on_trip' ? 'bg-blue-100' :
                      'bg-gray-100'
                    }`}>
                      <TruckIcon className={`h-5 w-5 ${
                        vehicle.currentStatus === 'active' ? 'text-green-600' :
                ...
                <div>
                  <div className="flex items-center space-x-3 mb-4">
                    <div className={`p-2 rounded-full ${
                      new Date(vehicle.insuranceExpiry) > new Date() ? 'bg-green-100' : 'bg-red-100'
                    }`}>
                      <ShieldCheckIcon className={`h-5 w-5 ${
                        new Date(vehicle.insuranceExpiry) > new Date() ? 'text-green-600' : 'text-red-600'
                      }`} />
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {new Date(vehicle.insuranceExpiry) > new Date() 
                          ? `${Math.ceil((new Date(vehicle.insuranceExpiry) - new Date()) / (1000 * 60 * 60 * 24))} days remaining`
                          : 'Expired'}
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <p className="text-sm font-medium text-gray-900">
                            ETB {record.cost?.toLocaleString()}
                          </p>
